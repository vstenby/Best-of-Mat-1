...
def parser():
    ...
    parser.add_argument('--clip-name', default=None, type=str,
                        help='specify which clip name you want to export.')
    parser.add_argument('--min-rating', default=1, type=int,  choices = range(1,11),
                        help='only export clips with rating >= minrating.')
    parser.add_argument('--max-rating', default=10, type=int, choices = range(1,11),
    ...
    parser.add_argument('--max-duration', default=np.inf, type=int,
    ...
    parser.add_argument('--min-t1', default=0, type=int, 
                        help='only export clips with mint1 <= t1.')
    parser.add_argument('--max-t1', default=np.inf, type=int,
                        help='only export clips with t1 <= maxt1.')
    parser.add_argument('--min-t2', default=0, type=int,
                        help='only export clips with mint2 <= t2.')
    parser.add_argument('--max-t2', default=np.inf, type=int,
    ...
    parser.add_argument('--normalize', default=True, action='store_true', help='normalize the audio of the output clip. this only works with mp4 at the moment.')
